...
def load_models():
    ...
    try:
        ...
        st.warning("⚠️ Models not found. Please run 'python src/models.py' first.")
    ...
    with tab4:
        ...
        if rf_model is not None:
            ...
            st.info(
                ...
                "With only 12 race samples in the demo dataset, predictions are approximate. "
            ...
            st.error("Models not loaded. Please train models first by running: `python src/models.py`")
    
    # Footer
    st.markdown("---")
    st.markdown(
        "**OptimalAthlete** - ML Sprint Performance System | "
        "Built for ISEG MSc Data Analytics Application 2025"
    )
