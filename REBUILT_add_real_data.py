"""
Add real 2025 race data to the database.
...
def add_real_races():
    ...
    races = [
        ...
        ("2025-05-10", 46.95, "Mary Peters Track, Belfast", "Good"),
...
def update_athlete_info():
    ...
    try:
        ...
        if athlete:
            ...
            athlete.personal_best_400m = 46.95
            athlete.date_of_birth = datetime(2000, 1, 1)
            athlete.gender = "Male"
...
if __name__ == "__main__":
    ...
    print("="*60)
    print("\nNext steps:")
    print("1. Retrain models: python models.py")
